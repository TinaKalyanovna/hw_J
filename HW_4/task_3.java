...
public class task_3 {
     public static void main(String[] args) {
        ...
        System.out.println(
                "Операции + , - , * ,  /  \n Ввести буквы 'Отм', если нужно вернуть предыдущий результат");
    ...
    public static String input_operation(Scanner scanner) {
        System.out.println("Введите знак (+, -, *, /) или 'Отм'");
        String oper = scanner.next().toLowerCase();
        if ((!oper.equals("+")) & (!oper.equals("-")) & (!oper.equals("*")) & (!oper
                    .equals("/")) & (!oper.equals("отм"))) {
                System.out.println("Это не знак и не 'отм'. Попробуйте снова!");
